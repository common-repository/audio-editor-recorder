...
if( ! function_exists('gspaudio_all_audio'))
{
function gspaudio_all_audio() {
	if(is_user_logged_in()){

		$message = gspaudio_all_audio_list();
...
add_shortcode('audio-editor-list', 'gspaudio_all_audio');

if( ! function_exists('gspaudio_all_audio_list'))
{
function gspaudio_all_audio_list(){
ob_start();
	?>
